...
# Task 7A.3: Define backward-compatibility constraints for public APIs (exports, constructors, config fields) and decide what gets deprecated vs preserved.

Plan item (Phase 1 – Discovery) from `plans/phase-7a-providers-and-extensibility-plan.md`: Define backward-compatibility constraints for public APIs (exports, constructors, config fields) and decide what gets deprecated vs preserved.
