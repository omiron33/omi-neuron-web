...
# Task 7A.16: Add layered config helpers (server/client) and update `NeuronWebProvider` patterns to avoid implying browser secrets.

Plan item (Phase 3 – Implementation) from `plans/phase-7a-providers-and-extensibility-plan.md`: Add layered config helpers (server/client) and update `NeuronWebProvider` patterns to avoid implying browser secrets.
