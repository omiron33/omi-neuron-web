...
# Task 7A.15: Introduce `AnalysisStep` + pipeline builder utilities and refactor `AnalysisPipeline` to use step composition.

Plan item (Phase 3 – Implementation) from `plans/phase-7a-providers-and-extensibility-plan.md`: Introduce `AnalysisStep` + pipeline builder utilities and refactor `AnalysisPipeline` to use step composition.
