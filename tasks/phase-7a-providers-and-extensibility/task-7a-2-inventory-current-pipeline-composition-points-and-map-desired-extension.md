...
# Task 7A.2: Inventory current pipeline composition points (what is hard-coded vs configurable) and map desired extension seams.

Plan item (Phase 1 – Discovery) from `plans/phase-7a-providers-and-extensibility-plan.md`: Inventory current pipeline composition points (what is hard-coded vs configurable) and map desired extension seams.
