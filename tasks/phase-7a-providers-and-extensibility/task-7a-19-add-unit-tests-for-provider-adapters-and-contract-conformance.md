...
# Task 7A.19: Add unit tests for provider adapters and contract conformance (mock provider, error mapping, retries).

Plan item (Phase 4 – Validation) from `plans/phase-7a-providers-and-extensibility-plan.md`: Add unit tests for provider adapters and contract conformance (mock provider, error mapping, retries).
