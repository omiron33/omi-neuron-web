...
# Task 7A.21: Verify backward compatibility (typecheck + example builds) and document any intentional deprecations.

Plan item (Phase 4 – Validation) from `plans/phase-7a-providers-and-extensibility-plan.md`: Verify backward compatibility (typecheck + example builds) and document any intentional deprecations.
