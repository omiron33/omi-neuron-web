...
# Task 7A.22: Update docs: provider guide, config layering guide, and “secure Next.js setup” reference snippets.

Plan item (Phase 4 – Validation) from `plans/phase-7a-providers-and-extensibility-plan.md`: Update docs: provider guide, config layering guide, and “secure Next.js setup” reference snippets.
