...
# Task 7A.5: Define provider contracts (`EmbeddingProvider`, `LLMProvider`, optional token/cost helpers) and decide method signatures + error semantics.

Plan item (Phase 2 – Design/Architecture) from `plans/phase-7a-providers-and-extensibility-plan.md`: Define provider contracts (`EmbeddingProvider`, `LLMProvider`, optional token/cost helpers) and decide method signatures + error semantics.
