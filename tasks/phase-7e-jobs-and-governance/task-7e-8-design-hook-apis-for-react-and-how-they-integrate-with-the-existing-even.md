...
# Task 7E.8: Design hook APIs for React (stream subscription and suggestions management) and how they integrate with the existing `EventBus`.

Plan item (Phase 2 – Design/Architecture) from `plans/phase-7e-jobs-and-governance-plan.md`: Design hook APIs for React (stream subscription and suggestions management) and how they integrate with the existing `EventBus`.
