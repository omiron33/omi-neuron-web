...
# Task 7E.19: Validate end-to-end flow: infer suggestions → approve → edges appear in graph queries.

Plan item (Phase 4 – Validation) from `plans/phase-7e-jobs-and-governance-plan.md`: Validate end-to-end flow: infer suggestions → approve → edges appear in graph queries.
