...
# Task 7B.17: Add integration tests to ensure API routes behave identically across backends for core operations.

Plan item (Phase 4 – Validation) from `plans/phase-7b-storage-backends-plan.md`: Add integration tests to ensure API routes behave identically across backends for core operations.
