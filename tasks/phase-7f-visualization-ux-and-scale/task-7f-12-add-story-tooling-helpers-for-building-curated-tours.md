...
# Task 7F.12: Add story tooling helpers (utility functions and/or hook helpers) for building curated tours.

Plan item (Phase 3 – Implementation) from `plans/phase-7f-visualization-ux-and-scale-plan.md`: Add story tooling helpers (utility functions and/or hook helpers) for building curated tours.
