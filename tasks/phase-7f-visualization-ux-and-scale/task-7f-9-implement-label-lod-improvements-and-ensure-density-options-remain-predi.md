...
# Task 7F.9: Implement label LOD improvements and ensure density options remain predictable at high node counts.

Plan item (Phase 3 – Implementation) from `plans/phase-7f-visualization-ux-and-scale-plan.md`: Implement label LOD improvements and ensure density options remain predictable at high node counts.
