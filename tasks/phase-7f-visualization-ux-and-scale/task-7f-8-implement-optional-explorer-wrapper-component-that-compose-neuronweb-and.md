...
# Task 7F.8: Implement optional explorer wrapper component(s) that compose `NeuronWeb` and expose slots for UI extensions.

Plan item (Phase 3 – Implementation) from `plans/phase-7f-visualization-ux-and-scale-plan.md`: Implement optional explorer wrapper component(s) that compose `NeuronWeb` and expose slots for UI extensions.
