...
# Task 7C.14: Add CLI commands + templates to scaffold connector config and run ingestion.

Plan item (Phase 3 – Implementation) from `plans/phase-7c-connectors-and-ingestion-plan.md`: Add CLI commands + templates to scaffold connector config and run ingestion.
