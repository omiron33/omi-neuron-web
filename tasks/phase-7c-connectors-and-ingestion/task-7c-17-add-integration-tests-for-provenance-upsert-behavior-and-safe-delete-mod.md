...
# Task 7C.17: Add integration tests for provenance upsert behavior and safe delete modes.

Plan item (Phase 4 – Validation) from `plans/phase-7c-connectors-and-ingestion-plan.md`: Add integration tests for provenance upsert behavior and safe delete modes.
