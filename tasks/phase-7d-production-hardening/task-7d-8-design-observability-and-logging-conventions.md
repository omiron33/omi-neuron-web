...
# Task 7D.8: Design observability and logging conventions (request id propagation, structured logs, error metadata).

Plan item (Phase 2 – Design/Architecture) from `plans/phase-7d-production-hardening-plan.md`: Design observability and logging conventions (request id propagation, structured logs, error metadata).
