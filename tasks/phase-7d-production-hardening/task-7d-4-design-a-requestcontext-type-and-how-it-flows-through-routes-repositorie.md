...
# Task 7D.4: Design a `RequestContext` type and how it flows through routes → repositories → store:

Plan item (Phase 2 – Design/Architecture) from `plans/phase-7d-production-hardening-plan.md`: Design a `RequestContext` type and how it flows through routes → repositories → store:
