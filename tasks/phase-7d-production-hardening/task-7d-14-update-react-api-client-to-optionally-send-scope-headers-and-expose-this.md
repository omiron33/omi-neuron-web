...
# Task 7D.14: Update React API client to optionally send scope headers and expose this via provider config.

Plan item (Phase 3 – Implementation) from `plans/phase-7d-production-hardening-plan.md`: Update React API client to optionally send scope headers and expose this via provider config.
