...
# Task 7D.12: Add optional auth hooks and guard middleware with safe defaults (no-op when not configured).

Plan item (Phase 3 – Implementation) from `plans/phase-7d-production-hardening-plan.md`: Add optional auth hooks and guard middleware with safe defaults (no-op when not configured).
