...
# Task 7D.5: Design DB schema changes for scoping:

Plan item (Phase 2 – Design/Architecture) from `plans/phase-7d-production-hardening-plan.md`: Design DB schema changes for scoping:
